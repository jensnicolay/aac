  ...
  (define (eval-atom ae ρ σ ctxs m r)
    ...
    (define (stack-alloc! τ κ)
      ...
      (define (touches d)
        ...
        (match d
          ((ev e ρ _ ι κ _ _ _) (set-union (env-addresses (↓ ρ (free e))) (apply set-union (set-map (stack-frames ι κ) touches))))
          ((ko ι κ v _ _ _ _) (set-union (apply set-union (set-map (stack-frames ι κ) touches)) (touches v)))
